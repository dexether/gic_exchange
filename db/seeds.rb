ADMIN_EMAIL = 'admin@pickcoinex.com'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@pickcoinex.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@pickcoinex.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
